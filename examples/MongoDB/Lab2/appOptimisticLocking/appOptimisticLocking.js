...
async function post_EditableRecord(req, res) {
  ...
  if (updateResult.matchedCount == 1) {
    ...
    postUpdate = { error: `Version ${newVersion.version} had already been updated` }
  }1
  res.status(201);
...
async function initWebService() {
  ...
  try {
    await collection.insertOne({ _id: newDocId, content: "A document people edit by hand", version: 1 })
